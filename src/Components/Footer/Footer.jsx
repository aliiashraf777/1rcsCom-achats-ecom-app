...
const FooterWrapper = styled.footer`
  ...
  .footer-bottom {
    padding-top: 36px;
    border-top: 1px solid rgba(150, 188, 189, 0.4);
      ...
      <Container className='container'>
                ...
                {footer.lists && (
                  <ul className="ftr-links">
                    {footer.lists?.map((list, index) => (
                      <li className="ftr-links-item text-white text-base" key={index}>
                        {list.text}
                      </li>
                    ))}
                  </ul>
        ...
        <div className="footer-middle grid">
          ...
          <div className="ftr-app-links">
            <p className="app-links-title text-white font-semibold text-lg">
              Download the App
            </p>
