                ...
                <div className="header-wrap flex items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <SiteBrandWrapper to='/' className='inline-flex'>
                            ...
                            <div className="site-brand-text text-outerspace">achats.</div>
                        </SiteBrandWrapper>
                    </div>
                    ...
                    <IconLinksWrapper className='flex items-center'>
                        ...
                        <Link
                            to='account'
                            className={`icon-link ${location.pathname === '/account' || location.pathname === '/account/add' ?
                                'active' : ''} inline-flex items-center justify-center `}
                        >
                        ...
                        <Link
                            to='/cart'
                            className={`icon-link ${location.pathname === '/cart' ? 'active' : ''} inline-flex items-center justify-center `}
                        >
