...
import { ColorsFilter, FilterTitle, FilterWrap, PriceFilter, ProductCategoryFilter, SizesFilter, StyleFilter } from "../../styles/filter";
    ...
    return (
        <div>
            <ProductCategoryFilter>
                ...
                <FilterWrap
                    className={`${isProductFilterOpen ? 'show' : 'hide'}`}
                >
                    {
            ...
            <PriceFilter>
                ...
                <FilterWrap
                    className={`range filter-wrap ${!isPriceFilterOpen ? 'hide' : ''}`}
                >
            ...
            <ColorsFilter>
                ...
                <FilterWrap
                    className={`${!isColorFilterOpen ? 'hide' : ''}`}
                >
            ...
            <SizesFilter>
                ...
                <FilterWrap
                    className={`${!isSizeFilterOpen ? 'hide' : 'show'}`}
                >
            ...
            >
                ...
                <FilterWrap
                    className={`${!isStyleFilterOpen ? 'hide' : 'show'}`}
                >
                    {
                        StyleFilterList?.map((styleFilter) => {
                            return (
                                ...
                                >
                                    <button
                                        type='button'
                                        clasName='filter-item-head w-full flex items-center justify-between'
                                    >
                                        <span className="filter-head-title text-base text-gray font-semibold">
                                            {styleFilter.title}
                                        </span>
