                ...
                <Container>
                    <div className="form-grid-content">
                        <div className="form-grid-left">
                            <img src={staticImages.form_img1} alt="" className='object-fit-cover' />
                        </div>

                        <div className="form-grid-right">
                            <FormTitle>
                                <h3>Check Email</h3>
                                <p>Please check your email inbox and click on the provided link
                            ...
                            <form>
                                <FormElement>
                                    ...
                                    <span className="from-elem-error">
                            ...
                            <p className="flex flex-wrap account-rel-text">
                                <Link to='/sign_in' className='font-medium'>
                                    <span className="text-underline">Back to Login
                                    </span>
                                </Link>
                            </p>
                        </div>
